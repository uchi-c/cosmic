 ...
 *
 * Ported from React Bits (LineSidebar, JS+CSS variant). Converted to
 * TypeScript; no behavioral changes — same rAF-driven proximity lerp for
 * color/shift/tick-scale, all reading one continuously-eased --effect value
 * per item so nothing staggers.
 */
